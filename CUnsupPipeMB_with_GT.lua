--[[
  ...
  local unsupPipeMB_with_GT = torch.class('unsupPipeMB_with_GT')

  function unsupPipeMB_with_GT:__init( imgTab, metadata, dispTab, hpatch, unique_name)
  ...
  function unsupPipeMB_with_GT:get(batch_size, net_fname)
