...
--function trainerNet.getMilContrastMax(img_w, disp_max, hpatch, dist_min, loss_margin, fnet)
...
--function trainerNet.getMilMax(img_w, disp_max, hpatch, loss_margin, fnet)
...
--function trainerNet.getDistNet(img_w, disp_max, hpatch, fnet)
...
--function trainerNet.getContrastMax(img_w, disp_max, hpatch, dist_min, loss_margin, fnet)  
...
--function trainerNet.getTripletNet(fnet)
